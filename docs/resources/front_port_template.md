...
- `name` (String)
- `rear_port_id` (Number) The rear port template this front port template is mapped to.
...
- `rear_port_position` (Number) Position on the rear port this front port template maps to. Defaults to `1`.
