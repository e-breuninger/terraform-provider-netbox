	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("data.netbox_tags.test", "tags.#", "1"),
					resource.TestCheckResourceAttrPair("data.netbox_tags.test", "tags.0.id", "netbox_tag.test_2", "id"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair("data.netbox_tags.test", "tags.0.id", "netbox_tag.test_1", "id"),
					resource.TestCheckResourceAttrPair("data.netbox_tags.test", "tags.1.id", "netbox_tag.test_2", "id"),
					resource.TestCheckResourceAttrPair("data.netbox_tags.test", "tags.2.id", "netbox_tag.test_3", "id"),
				),
			},
		},
	})
