...
func dataSourceNetboxVMInterfaces() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceNetboxVMInterfaceRead,
...
func dataSourceNetboxVMInterfaceRead(d *schema.ResourceData, m interface{}) error {
