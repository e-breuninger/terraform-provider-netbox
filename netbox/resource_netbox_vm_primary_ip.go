...
func resourceNetboxVMPrimaryIP() *schema.Resource {
	return &schema.Resource{
		Create: resourceNetboxVMPrimaryIPCreate,
		Read:   resourceNetboxVMPrimaryIPRead,
...
func resourceNetboxVMPrimaryIPCreate(d *schema.ResourceData, m interface{}) error {
	d.SetId(strconv.Itoa(d.Get("virtual_machine_id").(int)))

	return resourceNetboxVMPrimaryIPUpdate(d, m)
}

func resourceNetboxVMPrimaryIPRead(d *schema.ResourceData, m interface{}) error {
...
func resourceNetboxVMPrimaryIPUpdate(d *schema.ResourceData, m interface{}) error {
	api := m.(*client.NetBoxAPI)
	...
	return resourceNetboxVMPrimaryIPRead(d, m)
}

func resourceNetboxVMPrimaryIPDelete(d *schema.ResourceData, m interface{}) error {
